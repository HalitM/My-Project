...
@app.route("/")
def home():
    return 'This is Avelgers home page , <h1> Welcome Avelgers</h1>' 
...
@app.route('/about')
def about():
    return '<h1> This page is about Avelgers history </h1>'
...
@app.route('/error')
def error():
    return '<h1>You are not Avelgers!!! Fuck off.</h1>'
...
def greet_admin():
    return redirect(url_for('greet', name='Avelgers!!!!'))
